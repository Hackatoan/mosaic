...
export const config = {
  ...
  // Timeout for outbound calls to Pexels/Google Drive (search + tile
  // downloads) so a slow or hung upstream can't pin a job slot indefinitely.
  externalFetchTimeoutMs: intEnv("MOSAIC_EXTERNAL_FETCH_TIMEOUT_MS", 15000),
};
